...
const TasksPage = () => {
  ...
  return (
    <div className="p-4 lg:p-8 max-w-full mx-auto overflow-hidden">
      {/* Header */}
      <div className="mb-8">
          ...
          <div className="flex gap-3 flex-wrap">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 border border-[#BCC8BC] rounded-md focus:ring-2 focus:ring-blue-500 w-64"
              />
            </div>
            ...
            <select
              ...
              className="px-2.5 py-2 border border-[#BCC8BC] rounded-md focus:ring-2 focus:ring-blue-500"
            >
